...
Route::apiResource('posts-reports', PostsReportsController::class)->except(['index', 'destroy'])->middleware(['auth:sanctum']);
Route::get('posts-reports', [PostsReportsController::class, 'index'])->middleware(['auth:sanctum', 'admin']);
Route::delete('posts-reports/{posts_report}', [PostsReportsController::class, 'destroy'])->middleware(['auth:sanctum', 'admin']);
